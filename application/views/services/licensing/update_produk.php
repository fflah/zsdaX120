                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->nama_mesin?>" required type="text" name="nama_mesin" id="nama_mesin" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->merek_mesin?>" required type="text" name="merek_mesin" id="merek_mesin" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->kegunaan?>" required type="text" name="kegunaan" id="kegunaan" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->spesifikasi?>" required type="text" name="spesifikasi" id="spesifikasi" class="form-control col-xs-12 col-sm-5">
                                    <p style="margin-top: 41px;">Upload dokumen spesifikasi</p>
                                    <input style="margin-top: -5px;" type="file" name="dokumen_spesifikasi" id="dokumen_spesifikasi" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input type="file" name="foto_mesin" id="foto_mesin" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->pelabuhan_muat?>" required type="text" name="pelabuhan_muat" id="pelabuhan_muat" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-5">
                                <div class="clearfix">
                                    <input value="<?=$data_produk->nama_produk?>" required type="text" name="nama_produk" id="nama_produk" class="form-control col-xs-12 col-sm-5">
                                </div>
                            </div>
                        </div>
                        <div class="space-4"></div>
...
<script>
    ...
    $('#hs_code').val('<?=$data_produk->hs_code?>');
    $('#hs_code').trigger("chosen:updated");

    $('#asal_negara').val('<?=$data_produk->asal_negara?>');
    $('#asal_negara').trigger("chosen:updated");

    $('#pelabuhan_bongkar').val('<?=$data_produk->pelabuhan_bongkar?>');
    $('#pelabuhan_bongkar').trigger("chosen:updated");

    $('#sumber_pembiayaan').val("<?=$data_produk->sumber_pembiayaan?>")
</script>