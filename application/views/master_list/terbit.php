                        ...
                        <?php foreach ($data_permohonan as $key => $value) : ?>
                            ...
                            <tr class="d-style bgc-h-default-l4">
                                ...
                                <td class="text-grey">
                                    ...
                                    <?php if ($value->acc_dirjen == 'true'):?>
                                        <div><a target="_blank" href="<?=base_url('services/licensing/surat-rekomendasi?ref=')?><?=encode_id($value->id_formulir)?>"><span class='badge badge-warning badge-sm'>Download PDF</span></a></div>
                                        <?php else: ?>
                                            <div><span class='badge badge-danger badge-sm'>Permohonan ditolak</span></div>
                                    <?php endif?>
                                </td>
                                <td>
